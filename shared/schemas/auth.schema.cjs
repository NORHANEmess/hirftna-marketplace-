...
// CommonJS version of auth.schema — used by the Node.js backend.
// Frontend uses auth.schema.js (ESM) instead.
...
function normalizeVerifyOtpPayload(payload = {}) {
  return {
